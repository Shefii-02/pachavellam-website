...
class ModelExamController extends Controller
{
    ...
    public function model_exams_store(Request $request)
    {
        ...
        $new_one->category   = $request->category;
    ...
    public function model_exams_show()
    {
        ...
        $existingExams = DailyExam::where('section', 'Model Exam')->orderBy('created_at', 'desc')->take(25)->get();

        return view('cms.model-exam-show', compact('date_list', 'exam_titles', 'existingExams'));
    }
