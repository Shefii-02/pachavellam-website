...
@section('title', $title ?? "KPSC-Model Exam Leaderboard-" )
 ...
 <div class="card one col-sm-12">
  ...
  <div class="profile">
    ...
    <div class="person second">
      ...
      <img src="https://img.icons8.com/bubbles/100/000000/user.png" alt="" class="photo">
      <p class="link">@ {!! $list_attempt->get(1)->full_name !!}</p>
    ...
    <div class="person first">
      ...
      <img src="https://img.icons8.com/bubbles/100/000000/user.png" alt="" class="photo main">
      <p class="link">@ {!! $list_attempt->get(0)->full_name !!}</p>
    ...
    <div class="person third">
      ...
      <img src="https://img.icons8.com/bubbles/100/000000/user.png" alt="" class="photo">
      <p class="link">@ {!! $list_attempt->get(2)->full_name !!}</p>
        ...
        <div class="rest">
            <div class="others flex">
              ...
              <div class="info flex">
                ...
                <img src="https://img.icons8.com/bubbles/100/000000/user.png" alt="" class="p_img">
                <p class="link">@ {!! $list->full_name !!}</p>
                <p class="points">{!! number_format($list->total_mark,2) !!}</p>>
              </div>
            </div>
        </div>
      @endforeach
