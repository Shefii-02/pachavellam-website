            ...
            <div class="single-trending-post bg-dark  d-flex">
                ...
                <div class="post-content">
                      <div class="post-meta text-right d-inline float-right">
                            <a  href="{{url('kpsc/model-exam/'.$list_date->exam_date.'/'.$list_date->id)}}" class="bg-warning">
                                <i class="fa fa-clock-o"></i>  
                                {{date('h:i a',strtotime($list_date->started_at))}}           
                            </a>
                        </div>
                        <div class="post-meta text-right d-inline float-right">
                            <a  href="{{url('kpsc/model-exam/'.$list_date->exam_date.'/'.$list_date->id)}}" class="bg-danger">
                                <i class="fa fa-calendar mr-1"></i>  
                              {{date('d-M-Y',strtotime($list_date->exam_date))}} 
                        ...
                        <a class="post-title text-light text-capitalize mb-2" href="{{url('kpsc/model-exam/'.$list_date->exam_date.'/'.$list_date->id)}}">
                        {{$list_date->examtitle}} 
                        </a>
                   
                        <a href="{{url('kpsc/model-exam/'.$list_date->exam_date.'/'.$list_date->id)}}"  class="  py-2 badge badge-pill badge-primary mb-2">Attend for exam</a>
                       
                            <a href="{{ url('kpsc/model-exam/' . $list_date->exam_date . '/' . $list_date->id.'/answerkey') }}" class=" py-2 badge badge-pill badge-info mb-2">Answer Key</a>
         ...
         @endif
          ...
          <div class="single-trending-post bg-dark  d-flex">
            ...
            <div class="post-content">
                ...
                <a class="post-title text-light text-capitalize" href="{{url('kpsc/model-exam/'.$list_date->exam_date.'/'.$list_date->id)}}">
                    {{$list_date->examtitle}}
                </a>
                ...
                <div class="mb-1 mt-2 d-inline-flex">
                    ...
                    <div class="post-meta  mt-2 mb-2">
                        ...
                        <a  href="{{url('kpsc/model-exam/'.$list_date->exam_date.'/'.$list_date->id.'/leaderboard')}}" class="bg-success p-2">
