...
@section('title', $title ?? "KPSC-Materials-" )
@section('content')
    ...
    <div class="trending-news-wrapper">
      ...
      <div class="container">
        <div class="d-flex align-items-center justify-content-between">
          {{--<h5 class="mb-3 newsten-title">{{$material_list[0]->type}} </h5>--}}
        </div>
      </div> 
      <div class="container">
                  <div class=" col-lg-12">
            ...
            <div class='col-lg-12'>
                ...
                <div class="social-share ">
                    ...
                    നിങ്ങൾക്ക് ഉപകാരപ്പെട്ടെങ്കിൽ നിങ്ങളുടെ കൂട്ടുകാർക്ക് കൂടി ഷെയർ ചെയ്യുക                     ൽ...!!"
            ...
            <div class="post-content">
              ...
              <div class="post-meta d-flex align-items-center">
                <a  href="{{ Storage::url('files/'.$list->file_name) }}" download="{{$list->title}}">
                    <i class="fa fa-calendar"></i>   {{$list->date}}               
                </a>
              </div>
            </div>
