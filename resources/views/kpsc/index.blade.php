    ...
    <div class="editorial-choice-news-wrapper">
        ...
        <div class="container">
          <div class="editorial-choice-title text-center mb-4">
            <h4 class="newsten-title text-light">Latest Updates</h4>
          </div>
        </div>
                                ...
                                <div class="col-mg-6 col-lg-6 mb-3">
                                    <a href="/kpsc/daily-exam">
                                        @if($next_exam->started_at >= date('Y-m-d H:i:s'))
                                           ...
                                           <div class="col-lg-12">
                                               <marquee style="font-family:Book Antiqua; color: #FFFFFF" bgcolor="#000080" scrollamount="5" loop="3">Exam started... Exam started... Exam started... Exam started... Exam started... Exam started... Exam started... Exam started... Exam started... Exam started... Exam started...</marquee>
    ...
    <div class="editorial-choice-news-wrapper">
        ...
        <div class="container">
          <div class="editorial-choice-title text-center mb-4"><i class="lni lni-flickr"></i>
            <h4 class="newsten-title text-light">Latest youtube class's</h4>
          </div>
        </div>
        <div class="container">
              ...
              @endforeach --}}
                 @foreach($specialvideos as $videos)
                        <div class="single-editorial-slide ">
                            ...
                            <img src="https://img.youtube.com/vi/{{$videos->redirection}}/0.jpg" class="w-100 rounded-4">
                                    <span   style="transition-duration: 500ms;
                                                    font-size: 12px;margin-bottom: 0;
                                                    position: absolute;left: 0.5rem;
                                                    bottom: 0.5rem;z-index: 100;
