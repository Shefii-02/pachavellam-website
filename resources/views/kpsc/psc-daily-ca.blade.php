...
@section('title', $title ?? "KPSC- Current Affairs-")
@section('content')
    ...
    <div class="trending-news-wrapper">
        <div class="container">
            <div class="d-flex align-items-center justify-content-between">
                <h5 class="mb-3 newsten-title">Daily Current Affairs</h5>
            </div>
        </div>
        <div class="container">
            <div class=" col-lg-12">
                            ...
                            <div class="col-lg-12 col-sm-12  d-flex justify-content-center">
                                ...
                                <div class="col-lg-10 contact-main  rounded">
                                    ...
                                    <div class="container mt-3 row" >
                                        ...
                                        @foreach ($daily_ca_year as $list)
                                            <div class="col-md-3 col-12 h-25 text-center">
                                                <a href="{{url('/kpsc/psc-daily-current-affairs/'.Str::slug($list->year))}}" class="btn-btn-info   text-light">
                                                    <div class="card text-white {{div_background()}} min-height-100  mb-3 w-100" >
                                                    <h3 class="card-body text-light h5 card-title mt-4">{{$list->year}}</h3>
