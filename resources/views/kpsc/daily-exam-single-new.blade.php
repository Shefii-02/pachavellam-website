   ...
   function store_results(score,right,wrong,skipped){
       //result store 
        ...
        jQuery.ajax({
            ...
            cache: false,
            method : 'POST',
            data: {"score" :score, "skipped" :skipped,"_token" : token,"right" : right,"wrong" : wrong,"attempt" : attempt},
              ...
              <div class="columns  box">
                 ...
                 <div class="column  questionBox ">
                    ...
                    <transition enter-active-class="animated jackInTheBox" leave-active-class="animated zoomOut" mode="out-in">
                       ...
                       <div class="questionContainer" v-if="questionIndex<quiz.questions.length && quizStarted" v-bind:key="questionIndex">
                          ...
                          <div class="questionFooter">
                             ...
                             <nav class="pagination text-center" role="navigation" aria-label="pagination">
                                ...
                                <!-- prevButton -->
                                <a class="pagination-previous btn btn-warning text-light rounded " v-on:click="prev();" :disabled="questionIndex < 1">
                                 Previous Question
                               </a>
     
                                <!-- prevButton -->
                                <a class="pagination-next btn btn-info  text-light rounded" v-on:click="next();" :disabled="questionIndex>=quiz.questions.length">
                             ...
                             <div class="progressContainer">
                                <progress class="progress bg-success w-100" :value="(questionIndex/quiz.questions.length)*100" max="100">@{{(questionIndex/quiz.questions.length)*100}}%</progress>
                             </div>
                             <!--/progress-->
                       ...
                       <!--quizCompletedResult-->
                       <div v-if="questionIndex >= quiz.questions.length && quizStarted" v-bind:key="questionIndex" class="quizCompleted text-center">
