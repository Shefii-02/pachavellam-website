        ...
        <div class="newsten-footer-nav h-100">
          <ul class="h-100 d-flex align-items-center justify-content-between">
           <li class="active"><a href="{{url('/')}}"><i class="lni lni-home text-dark"></i><small>Home</small></a> </li>
            ...
            <li ><a href="{{url('kpsc/feed')}}"><i class="lni lni-heart text-dark"></i>  <small>Feed</small></a></li>
 
            <!--<li><a href="{{url('kpsc/daily-bucket')}}"><i class="lni lni-book text-dark"></i> <small>Roaring 40's</small></a> </li>-->
          
            <li><a href="{{url('kpsc/psc-daily-current-affairs')}}"><i class="lni lni-comments text-dark"></i> <small>C A</small></a> </li>
           
            <li><a href="{{url('kpsc/psc-bulletin')}}"><i class="lni lni-book text-dark"></i> <small>Psc Bulletin</small></a> </li>
