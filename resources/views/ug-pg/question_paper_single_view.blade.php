...
@section('title', $title ?? 'University-Question Papers')
@section('content')
        ...
        <div class="container"> 
            ...
            <div class="container mt-2 mb-5">
                ...
                <div class="col-lg-12 mt-3 mb-3">
                    <a href="{{ url(Storage::url('ug-pg/question-paper/'.$list->content)) }}" download="{{ url(Storage::url('ug-pg/question-paper/'.$list->content)) }}" class="btn btn-info rounded"><i class="fa fa-download"></i> Download Now</a>
                </div>
            ...
            @section('scripts')
            <script>
            let PDFFILE="{{ url(Storage::url('ug-pg/question-paper/'.$list->content)) }}";
