...
@section('title', $title ?? 'Special-class-Request')
@section('content')
...
<div class="form_wrapper">
  <div class="form_container">
         <marquee>
             <strong>
             {{-- പ്രവേശനം ആദ്യ൦  റെജിസ്റ്റർ  ചെയ്യുന്ന 25 പേർക്ക് മാത്രം . . .  Register now   👇 --}}
             </strong>
        </marquee>
    ...
    <div class=" clearfix">
      <div class="mb-5">
        <form action="request-class" class="mb-5" method="POST">
            @csrf
            ...
            <div class="input_field"> <span><i aria-hidden="true" class="fa fa-mobile"></i></span>
                <input type="text" name="mobile"  minlength="10" placeholder="Mobile number" required />
            </div>
            <div class="input_field"> <span><i aria-hidden="true" class="fa fa-building"></i></span>
                <input type="text" name="college" placeholder="College Name/Distance" required/>
            </div>
            ...
            <div class="input_field select_option">
                <select name="class_method" class="class_method" required>
            ...
            <div class="input_field"> 
                <textarea  name="comments" class="form-control" rows="3" placeholder="Extra comments">@php @endphp</textarea>
            </div>
          <input class="button mb-5" type="submit" name="submit" value="Register" />
        </form>
      </div>
    </div>
  </div>
