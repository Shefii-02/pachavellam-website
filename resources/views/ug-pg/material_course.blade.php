...
@section('title', $title ?? 'University-Material-Course')
@section('content')
                              ...
                              @include('ug-pg.share-current-page')
                                ...
                                @foreach ($list as $item)
                                    ...
                                    <div class="col-md-4 col-12 h-25 text-center">
                                        <a href="{{ug_pg('materials/'.$university_name.'/'.$level_name.'/'.$item->course_name)}}" class="btn-btn-info text-light">
                                            <div class="card text-white  min-height-100 bg1 mb-3 w-100" >
                                            <h3 class="card-body mt-3  text-uppercase text-light h6">{{$item->course_name}}</h3>
