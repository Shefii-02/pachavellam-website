	...
	<div class="offcanvas offcanvas-start flex-row custom-scrollbar h-100" style="    overflow-y: auto;" data-bs-backdrop="true" tabindex="-1" id="offcanvasSidebar">
		<div class="offcanvas-body sidebar-content d-flex flex-column bg-dark">
			...
			<div class="px-3 mt-auto pt-3">
                ...
                @can('General Setting Tab')
						<a class="h5 mb-0 text-body" href="{{url('admin/general')}}" data-bs-toggle="tooltip" data-bs-placement="top" title="Settings">
			...
			<div class="d-flex align-items-center w-100">
				...
				<div class="d-flex align-items-center d-xl-none">
					<a class="navbar-brand" href="index-2.html">
						<img class="light-mode-item navbar-brand-item h-60px" src="{{url('images/logo.png')}}" alt="">
						<img class="dark-mode-item navbar-brand-item h-60px" src="{{url('images/logo-2.png')}}" alt="">
					</a>
				</div>
				<!-- Logo END -->
                        ...
                        <div class="col-md-3 col-xxl-3">
                            <div class="card card-body bg-success bg-opacity-75 p-4 h-100">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <!-- Icon -->
                                    <div class="icon-lg rounded-circle bg-dark text-white mb-0"><i class=" bi bi-bank fa-fw"></i></div>
                                </div>
                            </div>
                        </div>
                            ...
                            <a href="{{url('admin/students')}}">
                                <div class="card card-body bg-dark bg-opacity-50 p-4 h-100">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div>
                                            <div class="d-flex">
                                                <h2 class="purecounter mb-0 fw-bold" data-purecounter-start="0" data-purecounter-end="1845"	data-purecounter-delay="200">0</h2>
                                                <span class="mb-0 h2 ms-1"></span>
                                            </div>
