	...
	<div class="offcanvas offcanvas-start flex-row custom-scrollbar h-100" style="    overflow-y: auto;" data-bs-backdrop="true" tabindex="-1" id="offcanvasSidebar">
		<div class="offcanvas-body sidebar-content d-flex flex-column bg-dark">
			...
			<ul class="navbar-nav flex-column" id="navbar-sidebar">
				...
				<!-- Menu item 1 -->
				<li class="nav-item" >
					<a href="{{ug_pg_cms('/')}}" class="nav-link  {!! active_menu("dashboard") !!}">
						<i class="bi bi-house fa-fw me-2"></i>Dashboard
					</a>
				</li>
				<!-- menu item 8 -->
				<li class="nav-item">
					<a class="nav-link {!! active_menu("our-videos") !!}"  href="{{ug_pg_cms('class-request')}}">
						<i class="bi bi-basket fa-fw me-2"></i>Class Request 
					</a>
				</li>
				<!-- menu item 7 -->
				<li class="nav-item">
					<a class="nav-link {!! active_menu("our-videos") !!}"  href="{{ug_pg_cms('banner-slider')}}">
						<i class="bi bi-basket fa-fw me-2"></i>Banner Slider
					</a>
				</li>
				<!-- menu item 8 -->
				<li class="nav-item">
					<a class="nav-link {!! active_menu("our-videos") !!}"  href="{{ug_pg_cms('notifications')}}">
						<i class="bi bi-basket fa-fw me-2"></i>Notifications
					</a>
				</li>
				<!-- menu item 9 -->
				<li class="nav-item">
					<a class="nav-link {!! active_menu("our-videos") !!}"  href="{{ug_pg_cms('special-videos')}}">
						<i class="bi bi-basket fa-fw me-2"></i>Special Videos
					</a>
				</li>
				<!-- menu item 10 -->
				<li class="nav-item">
					<a class="nav-link {!! active_menu("our-videos") !!}"  href="{{ug_pg_cms('news')}}">
						<i class="bi bi-basket fa-fw me-2"></i>News
					</a>
				</li>
				<!-- menu item 2 -->
				<li class="nav-item" >
					<a class="nav-link {!! active_menu("") !!} "  href="{{ug_pg_cms('university')}}">
						<i class="bi bi-basket fa-fw me-2"></i>University
					</a>
				</li>
                <!-- menu item 2 -->
                <li class="nav-item">
                    <a class="nav-link {!! active_menu("notifications") !!}"  href="{{ug_pg_cms('level')}}">
                        <i class="bi bi-basket fa-fw me-2"></i>Level
                    </a>
                </li>
                <!-- menu item 2 -->
                <li class="nav-item">
                    <a class="nav-link {!! active_menu("notifications") !!}"  href="{{ug_pg_cms('course')}}">
                        <i class="bi bi-basket fa-fw me-2"></i>Course
                    </a>
                </li>
				
                <!-- menu item 3 -->
                <li class="nav-item">
                    <a class="nav-link {!! active_menu("whats-new") !!}"  href="{{ug_pg_cms('semester')}}">
                        <i class="bi bi-basket fa-fw me-2"></i>Semester
                    </a>
                </li>
				<!-- menu item 3 -->
                <li class="nav-item">
                    <a class="nav-link {!! active_menu("whats-new") !!}"  href="{{ug_pg_cms('subjects')}}">
                        <i class="bi bi-basket fa-fw me-2"></i>Subjects
                    </a>
                </li>
                <!-- menu item 4 -->
                <li class="nav-item">
                    <a class="nav-link {!! active_menu("special-tab") !!}"  href="{{ug_pg_cms('question-paper')}}">
                        <i class="bi bi-basket fa-fw me-2"></i>Question Papper
                    </a>
                </li>
                <!-- menu item 5 -->
                <li class="nav-item">
                    <a class="nav-link {!! active_menu("our-videos") !!}"  href="{{ug_pg_cms('materials')}}">
                        <i class="bi bi-basket fa-fw me-2"></i>Material
                    </a>
                </li>
				<!-- menu item 6 -->
                <li class="nav-item">
                    <a class="nav-link {!! active_menu("our-videos") !!}"  href="{{ug_pg_cms('syllabus')}}">
			...
			<div class="px-3 mt-auto pt-3">
				<div class="d-flex align-items-center justify-content-between text-primary-hover">
						...
						<a class="h5 mb-0 text-body" href="{{url('ug-pg')}}" data-bs-toggle="tooltip" data-bs-placement="top" title="Home">
