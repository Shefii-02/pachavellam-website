...
.page{
  ...
  background-image: url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' version='1.1' height='100px' width='100px'><text transform='translate(20, 100) rotate(-45)' fill='rgba(245,245,220);' font-size='10'>Pachavellam</text></svg>");
}
  ...
  paginateText();
   ...
   <script>
    $(document).ready(function(){
        ...
        $("<div class='mt-1 mb-1'>Google Ads Spot</div>").insertAfter(".page");
