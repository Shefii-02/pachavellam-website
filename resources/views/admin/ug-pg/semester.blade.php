        ...
        <div class="card-body">
            ...
            <div class="row g-3 align-items-center justify-content-between mb-4">
                ...
                <div class="col-lg-12 new-section " style="display: none;">
                    <form action="{{ug_pg_cms('semester')}}" method="POST">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-lg-5 col-md-5 mb-2">
                             ...
                             <div class="col-lg-12 col-md-2 align-self-end">
            ...
            <div class="table-responsive border-0">
                <table class="table table-dark-gray align-middle p-4 mb-0 table-hover">
                    ...
                    <!-- Table body START -->
                    <tbody>
                       @foreach ($semester_list as $list3)
                        ...
                        <!-- Table item -->
                            <tr>
                                ...
                                <td>{{ucwords($list3->semester_name)}}</td>
                                ...
                                <td>
                                      @can('semester edit')
                                    <a data-bs-toggle="tooltip" data-bs-placement="top" title="Edit" href="#" data-position="{{$list3->position}}" data-university_name="{{$list3->university_name}}"   data-level_name="{{$list3->level_name}}"  data-course_name="{{$list3->course_name}}"  data-semester_name="{{remove_slug($list3->semester_name)}}"  data-id="{{$list3->id}}" class="btn btn-sm btn-info  btn-circle reset-banner"><i class="bi bi-pencil "></i></a>
                                    @endcan
                                      @can('semester delete')
                                    <a data-bs-toggle="tooltip" data-bs-placement="top" title="Delete" data-id="{{$list3->id}}" href="{{ug_pg_cms('semester/delete/'.$list3->id)}}" class="btn btn-sm btn-danger  btn-circle"><i class="bi bi-trash "></i></a>
                                    @endcan
                                </td>
                            </tr>
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="edit_banner_modal">Edit Semester</h5>
          <a href="#"  class="close"  data-bs-dismiss="modal" aria-label="Close">
            <span class="fa fa-times" aria-hidden="true"></span>
          </a>
        </div>
        <form action="{{ug_pg_cms('semester/updating')}}" method="POST">
