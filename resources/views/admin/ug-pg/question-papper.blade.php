    ...
    <div class="card bg-transparent border rounded-3">
        ...
        <div class="card-header bg-transparent border-bottom">
            <div class="row">
                    <!-- Content -->
                <div class="col-md-5">
                    <h3 class="mb-0">Add Question Paper</h3>    
                </div>
        ...
        <div class="card-body">
            ...
            <div class="row g-3 align-items-center justify-content-between mb-4">
                ...
                <div class="col-lg-12 ">
                    <form action="{{ug_pg_cms('question-paper')}}" method="POST"  enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-md-8 mb-3">
                                ...
                                <input class="form-control title" required  name="title"  >
                                   
                            </div>
                            <div class="col-lg-4 col-md-4 mb-3">
                                <label class="form-label">Year</label>
                                <input class="form-control year" required  name="year"  >
                            </div>
                            ...
                            <div class="col-lg-12 col-md-12 mb-3 material_content">
                                ...
                                <textarea class="form-control ckeditor" name="question_paper_content" id="editor"> </textarea>
                            </div>
                        </div>
