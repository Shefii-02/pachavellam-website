@extends('cms.section')
    ...
    <div class="card bg-transparent border rounded-3">
        ...
        <div class="card-header bg-transparent border-bottom">
            <div class="row">
                ...
                <!-- Select option -->
                <div class="col-md-6">
                    <a class="btn btn-sm btn-primary me-1 float-end" href="{{kpsc_cms('daily-exam')}}"><i class="bi bi-plus me-1"></i>Add New</a>
   ...
   <!-- Modal -->
            <div class="modal fade" id="exam_details" tabindex="-1" role="dialog" aria-labelledby="exam_detailsLabel" aria-hidden="true">
                        ...
                        <div class="form-group border-bottom mb-2 p-3 bg-light">
                            <div class="row">
                                <div class="col-md-12 mt-2">
                                    <label class="form-label">Exam Date</label>
                                            <input class="form-control" required id="exam_date_edit" type="date" name="exam_date" placeholder="" >
                                ...
                                <div class="col-md-12 mt-2">
                                   ...
                                   <input list="examtitle"  name="examtitle" id="examtitle_edit"  class="form-control" required autocomplete="off" >
                                ...
                                <div class="col-md-12 mt-2">
                                    <label class="form-label">Subject</label>
                                            ...
                                            <select  name="subject" id="subject_edit"  class="form-control" required autocomplete="off">
                                                 @foreach ($exam_subjects as $list)
                                                        <option value="{{$list->id}}">
                                                            {{$list->subject_title}}
                                                        </option>
            ...
            <!-- Modal -->
            <div class="modal fade" id="edit_question" tabindex="-1" role="dialog" aria-labelledby="edit_questionLabel" aria-hidden="true">
                            ...
                            <div class="  border-bottom mb-2 p-3 bg-light">
                                <div class="row">
                                    <div class="col-md-12 mt-2">
                                        ...
                                        <textarea class="form-control question" id="desc-editor-0" required  name="question" placeholder="Enter Question" rows="3"></textarea>
                                        
                                    </div>
                                    <div class="col-md-12 mt-2">
                                        <label class="form-label">Answer</label>
                                        <input class="form-control" required  autocomplete="off" id="answer"  type="text" name="answer" placeholder="Enter Answer" >
                                        
                                    </div>
                                    <div class="col-md-6 mt-2">
                                        <label class="form-label">Option1</label>
                                        <input class="form-control"  autocomplete="off" id="option1"  type="text" name="option1" placeholder="Enter Option1" >
                                    </div>
                                    <div class="col-md-6 mt-2">
                                        <label class="form-label">Option2</label>
                                        <input class="form-control"  autocomplete="off"  id="option2"  type="text" name="option2" placeholder="Enter Option2" >
                                    </div>
                                    <div class="col-md-6 mt-2">
                                        <label class="form-label">Option3</label>
                                        <input class="form-control"   autocomplete="off"  id="option3" type="text" name="option3" placeholder="Enter Option3" >
                                    </div>
                                    <div class="col-md-6 mt-2">
                                        <label class="form-label">Option4</label>
                                        <input class="form-control"  autocomplete="off"  id="option4"  type="text" name="option4" placeholder="Enter Option4" >
                                    </div>
                                </div>
                            </div>
                            <div class="modal-footer">
