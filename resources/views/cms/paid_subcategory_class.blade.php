    ...
    <div class="card bg-transparent border rounded-3">
        ...
        <div class="card-header bg-transparent border-bottom">
            <div class="row">
                    <!-- Content -->
                <div class="col-md-5">
                    <h3 class="mb-0">Paid Sub Category Class</h3>    
                </div>

                <!-- Select option -->
                <div class="col-md-7">
                    @can('Psc Paid Class sub Category add')
                    <!-- Short by filter -->
                    ...
                    <a class="btn btn-sm btn-primary me-1" href="paid_category_class" ><i class="bi bi-plus me-1"></i>Add|View-Category</a> 
                    @endcan
        ...
        <div class="card-body">
            ...
            <div class="row g-3 align-items-center justify-content-between mb-4">
                ...
                <div class="col-lg-12 new-section " style="display: none;">
                    @can('Psc Paid Class sub Category add')
                    <form action="{{url(kpsc_cms('paid_subcategory_class'))}}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-5">
                            ...
                            <div class="col-md-5">
                                <div class="col-md-12">
                                    ...
                                    <select class="form-control" required  name="category_name" >
                                        @foreach($category_paid as $category)
                                ...
                                <div class="col-md-12 mt-2">
                                    ...
                                    <input class="form-control" required type="text" name="subcategory_name" placeholder="Enter Category" >
                                    <div classs="col-md-2 ">
            ...
            <div class="table-responsive border-0">
                <table class="table table-dark-gray align-middle p-4 mb-0 table-hover">
                    ...
                    <!-- Table body START -->
                    <tbody>
                        @foreach ($subcategory_paid as $list)
                        ...
                        <!-- Table item -->
                            <tr>
                                ...
                                <!-- Table data -->
                                <td>
                                    @can('Psc Paid Class Sub Category edit')
                                    ...
                                    @endcan
                                    @can('Psc Paid Class Sub Category delete')
                                    <a  data-id="{{$list->id}}" href="{{route('adminkpsc.paid_subcategory.delete', $list->id)}}" class="btn btn-sm btn-danger me-1"><i class="bi bi-trash me-1"></i>Delete</a>
                                    @endcan
                                </td>
                            </tr>
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="edit_banner_modal">Edit Paid Sub Category</h5>
          <button type="button" class="close" onclick="$('#edit_banner').modal('hide');" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <form action="/admin/kpsc/paid_subcategory_class/update-freesubcategory" method="POST">
            <div class="modal-body">
                ...
                <div class="editbanner">
                    ...
                    <div class="col-md-12">
                        <label class="form-label">Sub Category Name</label>
                        <input class="form-control subcategory_name" required type="text" name="subcategory_name" placeholder="Enter Category" >
...
$('.reset-banner').click(function(event) {
    ...
    $('#edit_banner .picture').val(image);
    $("#edit_banner .uploaded-image").attr("src",image);

    $('#edit_banner .category_name option[value="'+category+'"]').attr("selected", "selected");
    $('#edit_banner .subcategory_name').val(subcategory);
    $('#edit_banner .id').val(id);
    $('#edit_banner .position').val(position);
