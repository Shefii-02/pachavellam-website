                        ...
                        <form action="" method="POST">
                            ...
                            <div class="row">
                                    ...
                                    <div
                                        ...
                                        <div>
                                            <label style="cursor:pointer;">
                                                <span>
                                                    <input class="form-control stretched-link pic1" type="file"
                                                        accept="image/*" id="pic1" name="my-image"
                                ...
                                <div class="col-md-5">
                                    ...
                                    <input class="form-control" type="text" name="redirection"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <!-- Image -->
                                            <div class="w-100px">
                                                <img src="{{ Storage::url('files/' . $list->image) }}" class="rounded"
                                                    alt="">
                                            </div>
                                    ...
                                    <td>
                                        @can('special Tab edit')
                                            <a data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Reset"
                                                aria-label="Reset" href="#" data-id="{{ $list->id }}"
                                        ...
                                        @can('special Tab delete')
                                            <a data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Delete"
                                                aria-label="Delete" data-id="{{ $list->id }}"
                                                href="{{ route('adminkpsc.special-tab.delete', $list->id) }}"
        ...
        $('body').on('change','.pic1',function() {
            ...
            if (file) {
                ...
                reader.onload = function(event) {
                    ...
                    $("#picture1,#picture2").val(event.target.result);
                };
