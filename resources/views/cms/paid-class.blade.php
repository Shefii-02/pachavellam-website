    ...
    <div class="card bg-transparent border rounded-3">
        ...
        <div class="card-header bg-transparent border-bottom">
            <div class="row">
                    <!-- Content -->
                <div class="col-md-5">
                    <h3 class="mb-0">Psc Paid Class</h3>    
                </div>
                ...
                <div class="col-md-7 text-end">
                    ...
                    <!--<a class="btn btn-sm btn-info me-1" href="paid_category_class" ><i class="bi bi-plus me-1"></i>Add|View-Category</a> -->
                    @endcan
                    @can('Psc Paid Class Sub Category list')
                    <!--<a class="btn btn-sm btn-info me-1" href="paid_subcategory_class" ><i class="bi bi-plus me-1"></i>Add|View-Sub Category</a>-->
                    @endcan
                    <br>
                    @can('Psc Paid Class add')
        ...
        <div class="card-body row">
            ...
            <form method="GET" action="paid-class-list">
                <div class="row">
            ...
            @if(isset($class_list))
                ...
                <div class="table-responsive border-0 mt-5">
                    <table class="table table-dark-gray align-middle p-4 mb-0 table-hover">
                        ...
                        <thead>
                            <tr>
                                <th scope="col" class="border-0 rounded-start">Category</th>
                        ...
                        <tbody>
                            ...
                            <!-- Table item -->
                                <tr>
                                    ...
                                    <!-- Table data -->
                                    <td>
                                        @can('Psc Paid Class edit')
                                        <a data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Reset" aria-label="Reset"  href="#" data-position="{{$list->position}}" data-link="{{$list->link}}" data-title="{{$list->title}}" data-id="{{$list->id}}" data-category="{{$list->category_id}}" data-subcategory="{{$list->subcategory_id}}" class="btn btn-sm btn-info  reset-banner btn-circle"><i class="bi bi-pencil "></i></a>
                                        @endcan
                                        @can('Psc Paid Class delete')
                                        <a  data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Delete" aria-label="Delete"  data-id="{{$list->id}}" href="{{route('adminkpsc.paid-class.delete', $list->id)}}" class="btn btn-sm btn-danger btn-circle"><i class="bi bi-trash "></i></a>
                                        @endcan
                                    </td>
                                </tr>
 ...
 <div class="modal fade" id="add_modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Paid Class Adding Form</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <form action="{{url(kpsc_cms('paid-class'))}}" method="POST">
            @csrf()
  ...
  <div class="modal fade" id="csv_modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Paid Class Csv Type</h5>

          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        
        <form action="paid-class/paid-class-csvtype" method="POST" enctype="multipart/form-data">
            @csrf()
            <div class="modal-body row">
                <div classs="col-md-12 ">
                
                    <a href="" class="btn btn-success float-end btn-sm"><span class="bi bi-download"></span> Sample Csv format</a>
                </div>
...
<div class="modal fade" id="edit_freeclass" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Edit Paid Class</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <form action="{{url(kpsc_cms('paid-class/update-paidclass'))}}" method="POST">
            @csrf()
            <div class="modal-body row">
                <div class="col-md-6 mt-2">
                    <label class="form-label">Category</label>
