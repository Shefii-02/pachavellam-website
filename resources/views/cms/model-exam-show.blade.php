    ...
    <div class="card bg-transparent border rounded-3">
        ...
        <div class="card-header bg-transparent border-bottom">
            <div class="row">
                ...
                <!-- Select option -->
                <div class="col-md-6">
                    <a class="btn btn-sm btn-primary me-1 float-end" href="{{kpsc_cms('model-exam')}}"><i class="bi bi-plus me-1"></i>Add New</a>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                        <form action="{{kpsc_cms('model-exam/edit-details/'.$list->id)}}" enctype="multipart/form-data" method="POST">
                        @csrf
                        <div class="form-group border-bottom mb-2 p-3 bg-light">
                            <div class="row">
                                ...
                                <div class="col-md-12 mt-2">
                                   ...
                                   <input type="text"  name="examtitle" id="examtitle_edit"  class="form-control" required autocomplete="off" >
