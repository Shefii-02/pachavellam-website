        ...
        <div class="card-header bg-transparent border-bottom">
            <div class="row">
                ...
                <div class="col-md-7 text-end">
                    ...
                    <a class="btn btn-sm btn-primary me-1" href="{{route('adminkpsc.subjects.index')}}" ><i class="bi bi-plus me-1"></i>Add|View Subject</a>
                    {{-- @endcan--}}
        ...
        <div class="card-body">
            ...
            <div class="row g-3 align-items-center justify-content-between mb-4">
                ...
                <div class="col-lg-12 new-section " style="display: none;">
                    {{-- @can('Psc Subjects Add') --}}
                    <form action="{{url(kpsc_cms('sub-subjects/create'))}}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-5">
                            ...
                            <div class="col-md-5">
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <select class="form-control" name="parent">
                                        ...
                                        <option value="{{$itm->id}}">{{$itm->subject_title}} </option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                ...
                <table class="table table-dark-gray align-middle p-4 mb-0 table-hover">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th scope="col" class="border-0">Parent Subject</th>
                            ...
                            <tr>
                                ...
                                <td>
                                   {{--  @can('Psc Subject edit') --}}
                                    <a href="{{route('adminkpsc.sub-subjects.edit', $list->id)}}" class="btn btn-sm btn-info me-1 reset-banner"><i class="bi bi-pencil me-1"></i>Reset</a>
                                    {{-- @endcan --}}
                                    {{-- @can('Psc Subject delete') --}}
                                    <a   href="{{route('adminkpsc.sub-subjects.delete', $list->id)}}" class="btn btn-sm btn-danger me-1"><i class="bi bi-trash me-1"></i>Delete</a>
                                   {{-- @endcan --}}
                                </td>
                            </tr>
