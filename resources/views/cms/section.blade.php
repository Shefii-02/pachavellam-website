            ...
            <div class="offcanvas-body sidebar-content d-flex flex-column bg-dark">
                ...
                <ul class="navbar-nav flex-column" id="navbar-sidebar">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {!! active_menu('material') !!}" href="{{ url('admin/kpsc/material') }}">
                            <i class="bi bi-file-earmark-arrow-down-fill fa-fw me-2"></i>Study Material
                        </a>
                    </li>
				 ...
				 <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {!! active_menu('special-videos') !!}" href="{{ url('admin/kpsc/special-videos') }}">
                            <i class="bi bi-camera-reels fa-fw me-2"></i>Youtube Class
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link {!! active_menu('daily-ca') !!}" href="{{ url('admin/kpsc/daily-ca') }}">
                            <i class="bi bi-bookmark-star-fill fa-fw me-2"></i>Daily CA
                        </a>
                    </li>
                    <!-- menu item 10 -->
                    <li class="nav-item">
                        <a class="nav-link {!! active_menu('psc-bulletin') !!}" href="{{ url('admin/kpsc/psc-bulletin') }}">
                            <i class="bi bi-patch-question-fill fa-fw me-2"></i>Psc Bulletin
                        </a>
                    </li>
                    <!-- menu item 11 -->
                    <li class="nav-item">
                ...
                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {!! active_menu('notifications') !!}" href="{{ url('admin/kpsc/notifications') }}">
                            <i class="bi bi-bell-fill fa-fw me-2"></i>Notifications
                        </a>
                    </li>
                    <!-- menu item 14 -->
                    <li class="nav-item">
                        <a class="nav-link {!! active_menu('psc-results') !!}" href="{{ url('admin/kpsc/psc-results') }}">
                            <i class="bi bi-file-earmark-spreadsheet fa-fw me-2"></i>Psc Results
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link {!! active_menu('syllabus') !!}" href="{{ url('admin/kpsc/syllabus') }}">
                            <i class="bi bi-plus-slash-minus fa-fw me-2"></i>Syllabus
                        </a>
                    </li>
                    <!-- menu item 16 -->
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {!! active_menu('banner-slider') !!} " href="{{ url('admin/kpsc/banner-slider') }}">
                            <i class="bi bi-card-image fa-fw me-2"></i>Stories
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link {!! active_menu('capsule') !!}" href="{{ url('admin/kpsc/capsule') }}">
                            <i class="bi bi-file-image-fill fa-fw me-2"></i>Capsule
                        </a>
                    </li>
                ...
                <div class="px-3 mt-auto pt-3">
                    <div class="d-flex align-items-center justify-content-between text-primary-hover">
                        <a class="h5 mb-0 text-body" href="{{ url('admin/dashboard') }}" data-bs-toggle="tooltip"
                            data-bs-placement="top" title="Settings">
                            <i class="bi bi-gear-fill"></i>
                        </a>
                        <a class="h5 mb-0 text-body" href="{{ url('kpsc') }}" data-bs-toggle="tooltip"
                ...
                <div class="d-flex align-items-center w-100">
                    ...
                    <div class="d-flex align-items-center d-xl-none">
                        <a class="navbar-brand" href="index-2.html">
                            <img class="light-mode-item navbar-brand-item h-60px"
                                src="https://www.pachavellam.com/assets/images/home/logo.png" alt="">
                            <img class="dark-mode-item navbar-brand-item h-60px"
                                src="https://www.pachavellam.com/assets/images/home/logo-2.png" alt="">
                        </a>
                    </div>
                    <!-- Logo END -->
