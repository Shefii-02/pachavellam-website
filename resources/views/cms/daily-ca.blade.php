        ...
        <div class="card-header bg-transparent border-bottom">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <!-- Short by filter -->
                    <button class="btn btn-sm btn-primary me-1"  data-bs-toggle="modal" data-bs-target="#link_modal"><i class="bi bi-plus me-1"></i>Add Link</button> 
                    @endcan
                    @can('Daily Ca pdf add')
                    <button class="btn btn-sm btn-primary me-1"  data-bs-toggle="modal" data-bs-target="#pdf_modal"><i class="bi bi-plus me-1"></i>Add Pdf</button>
                    @endcan
                    ...
                    @endcan
                    @can('Daily Ca add')
                    <button class="btn btn-sm btn-primary me-1"  data-bs-toggle="modal" data-bs-target="#add_modal"><i class="bi bi-plus me-1"></i>Add New</button>
                    @endcan
            ...
            <form method="GET" action="{{kpsc_cms('daily-ca/daily-ca-show')}}" >
                <div class="row">
                    ...
                    <div classs="col-md-2  mt-2">
                        <button type="submit" class="btn btn-success prev-btn mb-0 mt-3"><i class="bi bi-search me-1"></i> Submit</button>
                    </div>
                </div>
                                ...
                                <!-- Table item -->
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if ($list->type == 'Link')
                                            <a data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Reset" aria-label="Reset"   data-id="{{$list->id}}" data-year="{{$list->year}}" data-month="{{$list->month}}" data-title="{{$list->title}}" data-link="{{$list->file_name}}" class="btn btn-sm btn-info  edit_linktype btn-circle"><i class="bi bi-pencil "></i></a>

                                            @elseif ($list->type == 'Pdf')
                                            <a data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Reset" aria-label="Reset"   data-id="{{$list->id}}" data-year="{{$list->year}}" data-month="{{$list->month}}" data-title="{{$list->title}}" class="btn btn-sm btn-info  edit_pdftype btn-circle"><i class="bi bi-pencil "></i></a>

                                            @elseif ($list->type == 'Day')
                                            <a data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Reset" aria-label="Reset"  data-id="{{$list->id}}" data-year="{{$list->year}}" data-month="{{$list->month}}" data-day="{{$list->day}}" data-question="{{$list->question}}" data-answer="{{$list->answer}}" data-note="{{$list->note}}" class="btn btn-sm btn-info me-1 edit_daytype btn-circle"><i class="bi bi-pencil "></i></a>
                                            ...
                                            @can('Daily Ca delete')
                                            <a data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Delete" aria-label="Delete"  data-id="{{$list->id}}" href="{{route('adminkpsc.daily-ca.delete', $list->id)}}" class="btn btn-sm btn-danger  btn-circle"><i class="bi bi-trash"></i></a>
                                            @endcan
                                        </td>
                                    </tr>
        ...
        <form action="{{kpsc_cms('daily-ca/daily-ca-linktype')}}" method="POST">
            ...
            <div class="modal-body row">
                <div class="col-md-6 mt-2">
                    <label class="form-label">Year</label>
                    <input  list="year"  autocomplete="off" class="form-control" required  type="text" name="year" placeholder="Enter Year" >
                    <datalist id="year">
                        @foreach($daily_ca as $year_list)
                            <option>{{$year_list->year}}</option>
                        @endforeach
                ...
                <div class="col-md-6 mt-2">
                    <label class="form-label">Month</label>
                    <input  list="month"  autocomplete="off"  class="form-control" required  type="text" name="month" placeholder="Enter Month" >
                     <datalist id="month">
                    ...
                    <div class="{{$rand}}">
                        <div class="row">
                            ...
                            <div class="col-md-6 mt-2">
                                ...
                                <input class="form-control" required accept=".pdf" type="file" name="file"  >
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <form action="{{kpsc_cms('daily-ca/daily-ca-csvtype')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="modal-body row">
                <div classs="col-md-12 ">
                    ...
                    <a href="{{url('sample-file/daily-ca.csv')}}" download class="btn btn-success float-end btn-sm"><span class="bi bi-download"></span> Sample Csv format</a>
                </div>
                <div class="col-md-6 mt-2">
                    <label class="form-label">Year</label>
                    <input  list="year" autocomplete="off"   class="form-control" required type="text" name="year" placeholder="Enter Year" >
                    ...
                    <div class="{{$rand}}">
                        <div class="row">
                            <div class="col-md-6 mt-2">
                                ...
                                <input list="day"  autocomplete="off"  class="form-control" required  type="text" name="day" placeholder="Enter Day" >
...
<div class="modal fade" id="add_modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <form action="{{kpsc_cms('daily-ca')}}" method="POST">
        ...
        <div class="modal-body row">
            <div class="col-md-4 mt-2">
                <label class="form-label">Year</label>
                <input  list="year" autocomplete="off"   class="form-control" required  type="text" name="year" placeholder="Enter Redirection link" >
                    <datalist id="year">
                        @foreach($daily_ca as $year_list)
                            <option>{{$year_list->year}}</option>
                        @endforeach
            ...
            <div class="col-md-4 mt-2">
                <label class="form-label">Month</label>
                <input list="month"  autocomplete="off"  class="form-control" required  type="text" name="month" placeholder="Enter Redirection link" >
            ...
            <div class="col-md-4 mt-2">
                <label class="form-label">Day/Subject</label>
                <input list="day"  autocomplete="off"  class="form-control" required  type="text" name="day" placeholder="Enter Redirection link" >
            ...
            <div classs="col-md-12 ">
                <span class="btn btn-success btn-sm  mb-0 mt-3 float-end add_new3"><i class="bi bi-plus me-1"></i> Add</span>
            </div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
...
<div class="modal fade" id="edit_daytype" tabindex="-1" aria-labelledby="edit_day" aria-hidden="true">
    ...
    <form action="{{kpsc_cms('daily-ca/edit-ca-day-update')}}" method="POST">
        ...
        <div class="modal-body row">
            <div class="col-md-4 mt-2">
                <label class="form-label">Year</label>
                <input  list="year" autocomplete="off"   class="form-control year" required  type="text" name="year" placeholder="Enter Year" >
                    <datalist id="year">
                        @foreach($daily_ca as $year_list)
                            <option>{{$year_list->year}}</option>
                        @endforeach
            ...
            <div class="col-md-4 mt-2">
                <label class="form-label">Month</label>
                <input list="month"  autocomplete="off"  class="form-control month" required  type="text" name="month" placeholder="Enter  Month" >
            ...
            <div class="col-md-4 mt-2">
                <label class="form-label">Day/Subject</label>
                <input list="day"  autocomplete="off" class="form-control day" required  type="text" name="day" placeholder="Enter  Day" >
            ...
            <div class="section-div3">
                ...
                <div class="{{$rand}}">
                    <div class="row">
                        <div class="col-md-4 mt-2">
                            <label class="form-label">Question</label>
                            <input class="form-control question" required  type="text" name="question" placeholder="Enter Question" >
                            
                        </div>
                        <div class="col-md-4 mt-2">
                            <label class="form-label">Answer</label>
                            <input class="form-control answer" required type="text" name="answer" placeholder="Enter Answer" >
                            
                        </div>
                        <div class="col-md-4 mt-2">
                            <label class="form-label">Note</label>
                            <input class="form-control note"   type="text" name="note" placeholder="Enter Note" >
                        </div>
                ...
                <div class="section-div">
                    ...
                    <div class="{{$rand}}">
                        <div class="row">
                            <div class="col-md-6 mt-2">
                                <label class="form-label">Title</label>
                                <input class="form-control title" required type="text" name="title" placeholder="Enter Redirection link" >
                            </div>
                            <div class="col-md-6 mt-2">
                                <label class="form-label">Link</label>
                                <input class="form-control link" required  type="text" name="link" placeholder="Enter Redirection link" >
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="modal fade" id="edit_pdftype" tabindex="-1" aria-labelledby="edit_pdf" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <form action="{{kpsc_cms('daily-ca/daily-ca-pdftype-update')}}" method="POST" enctype="multipart/form-data">
            @csrf()
            <div class="modal-body row">
                <div class="col-md-6 mt-2">
                    <label class="form-label">Year</label>
                ...
                <div class="section-div2">
                    ...
                    <div class="{{$rand}}">
                        <div class="row">
                            <div class="col-md-6 mt-2">
                                <label class="form-label">Title</label>
                                <input class="form-control title" required  type="text" name="title" placeholder="Enter Title" >
                            </div>
                            <div class="col-md-6 mt-2">
                                <label class="form-label">File</label>
