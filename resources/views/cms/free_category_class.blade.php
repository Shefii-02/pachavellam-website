    ...
    <div class="card bg-transparent border rounded-3">
        ...
        <div class="card-header bg-transparent border-bottom">
            <div class="row">
                    <!-- Content -->
                <div class="col-md-5">
                    <h3 class="mb-0">Free Category Class</h3>    
                </div>

                <!-- Select option -->
                <div class="col-md-7">
                    @can('Psc Free Class category add')
                    <!-- Short by filter -->
                    ...
                    <a class="btn btn-sm btn-primary me-1" href="free_subcategory_class" ><i class="bi bi-plus me-1"></i>Add|View-Sub Category</a>
                    @endcan
        ...
        <div class="card-body">
            ...
            <div class="row g-3 align-items-center justify-content-between mb-4">
                ...
                <div class="col-lg-12 new-section " style="display: none;">
                    @can('Psc Free Class category add')
                    <form action="{{url(kpsc_cms('free_category_class'))}}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-5">
                    ...
                    <tbody>
                        ...
                        <!-- Table item -->
                            <tr>
                                ...
                                <!-- Table data -->
                                <td>
                                    @can('Psc Free Class Category edit')
                                    <a href="#" data-position="{{$list->position}}" data-category="{{$list->category_name}}"  data-image="{{ url(Storage::url('files/'.$list->image)) }}"  data-id="{{$list->id}}" class="btn btn-sm btn-info me-1 reset-banner"><i class="bi bi-pencil me-1"></i>Reset</a>
                                    @endcan
                                    @can('Psc Free Class Category delete')
                                    <a  data-id="{{$list->id}}" href="{{route('adminkpsc.free_category.delete', $list->id)}}" class="btn btn-sm btn-danger me-1"><i class="bi bi-trash me-1"></i>Delete</a>
                                    @endcan
                                </td>
                            </tr>
...
<div class="modal fade" id="edit_banner" tabindex="-1" role="dialog" aria-labelledby="edit_banner_modal" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <form action="/admin/kpsc/free_category_class/update-freecategory" method="POST">
