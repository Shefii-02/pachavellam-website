    ...
    <div class="card bg-transparent border rounded-3">
        ...
        <div class="card-header bg-transparent border-bottom">
            <div class="row">
                <!-- Content -->
                <div class="col-md-6">
                    <h3 class="mb-0">Current Affairs Daily Exam Edit</h3>
                </div>
                <!-- Select option -->
                <div class="col-md-6">
        ...
        <div class="card-body row">
            ...
            <div class="row g-3 align-items-center justify-content-between mb-4">
                ...
                <div class="col-lg-12 new-banner-section ">
                    <form action="{{ kpsc_cms('ca-daily-exam/update/' . $exam_detail->id) }}" method="POST">
                        @csrf
                        <div class="form-group border-bottom mb-2 p-3 bg-light">
                            <div class="row">
                                <div class="col-md-4 mt-2">
                                    <label class="form-label">Exam Title</label>
                                    <select name="level" class="form-control" required autocomplete="off">
                                        @for ($i = 1; $i <= 100; $i++)
                                            @if (!$examDays->contains($i) || $i == $exam_detail->level)
                                                <option value="{{ $i }}" {{ $i == $exam_detail->level ? 'selected' : '' }}>Day {{ $i }}</option>
                                            @endif
                                        @endfor
                                    </select>
                                </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ kpsc_cms('ca-daily-exam/save-question/' . $exam_detail->id) }}" method="POST">
                        @csrf
                        <div class="form-group border-bottom mb-2 p-3 bg-light">
                            <div class="">
                                <div class="">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('body').on('click', '.remove-div', function() {
                ...
                $.ajax({
                    url: "{{ kpsc_cms('ca-daily-exam/question-delete') }}",
            ...
            $('body').on('click', '.editQuestion', function() {
                var id = $(this).data('id');
                $.ajax({
                    url: "{{ kpsc_cms('ca-daily-exam/question-edit') }}",
                    cache: false,
                    data: {
                        'id': id
                    },
