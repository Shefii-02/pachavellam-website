    ...
    <div class="card bg-transparent border rounded-3">
        ...
        <div class="card-header bg-transparent border-bottom">
            <div class="row">
                    <!-- Content -->
                <div class="col-md-5">
                    <h3 class="mb-0">Free Sub Category Class</h3>    
                </div>

                <!-- Select option -->
                <div class="col-md-7">
                    <!-- Short by filter -->
                    @can('Psc Free Class sub Category add')
                    ...
                    <a class="btn btn-sm btn-primary me-1" href="free_category_class" ><i class="bi bi-plus me-1"></i>Add|View-Category</a> 
                    @endcan
                    @can('Psc Free Class list')
                    <a class="btn btn-sm btn-primary me-1" href="free-class" ><i class="bi bi-plus me-1"></i>Add|View-FreeClass</a> 
                   @endcan
        ...
        <div class="card-body">
            ...
            <div class="row g-3 align-items-center justify-content-between mb-4">
                ...
                <div class="col-lg-12 new-section " style="display: none;">
                    @can('Psc Free Class sub Category add')
                    <form action="{{url(kpsc_cms('free_subcategory_class'))}}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-5">
                            ...
                            <div class="col-md-5">
                                <div class="col-md-12">
                                    ...
                                    <select class="form-control" required  name="category_name" >
                                        @foreach($category_free as $category)
            ...
            <div class="table-responsive border-0">
                <table class="table table-dark-gray align-middle p-4 mb-0 table-hover">
                    ...
                    <!-- Table body START -->
                    <tbody>
                        @foreach ($subcategory_free as $list)
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="edit_banner_modal">Edit Free Sub Category</h5>
          <button type="button" class="close" onclick="$('#edit_banner').modal('hide');" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <form action="/kpsc/cms/free_subcategory_class/update-freesubcategory" method="POST">
