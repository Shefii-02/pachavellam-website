                        ...
                        @foreach($psc_news as $news_list)
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @endcan
                                    @can('Psc News delete')
                                    <a data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Delete" aria-label="Delete"   data-id="{{$news_list->id}}" href="{{route('adminkpsc.psc-news.delete', $news_list->id)}}" class="btn btn-sm btn-danger  btn-circle"><i class="bi bi-trash "></i></a>
                                    @endcan
                                </td>
                            </tr>
                        @endforeach
