            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    @can('Special Videos Add')
                        <!-- Short by filter -->
                        <a href="#" class="btn btn-sm btn-primary me-1 add_new_banner"><i class="bi bi-plus me-1"></i>Add
                            New</a>
                    @endcan
                    ...
                    @can('Special Videos Add')
                        <form action="" method="POST">
                            <div class="row">
                                ...
                                <div class="col-md-5 mb-2">
                                    <label class="form-label">Redirection
                                        <small class="text-danger">(Eg:- https://youtu.be/HT6h0OsVrso)</small></label>
                                    <input class="form-control" type="url" name="redirection"
                        ...
                        <tbody>
                            @foreach ($spcl_videos as $videos)
                                ...
                                <tr>
                                    ...
                                    <td>{{ $videos->title }}</td>
                                    <td><a
                                            href="https://youtu.be/{{ $videos->redirection }}">https://youtu.be/{{ $videos->redirection }}</a>
                                    </td>
                                    ...
                                    <td>
                                        @can('Special Videos Edit')
                                            <a data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Reset"
                                                aria-label="Reset" href="#" data-id="{{ $videos->id }}"
                                        ...
                                        @can('Special Videos delete')
                                            <a data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Delete"
                                                aria-label="Delete" data-id="{{ $videos->id }}"
                                                href="{{ route('adminkpsc.special-videos.delete', $videos->id) }}"
    ...
    <div class="modal fade" id="edit_banner" tabindex="-1" role="dialog" aria-labelledby="edit_banner_modal"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="/admin/kpsc/special-videos/update-spclvideos" method="POST">
