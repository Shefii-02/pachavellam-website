...
@section('content2')
                        ...
                        <div class="row">
                                ...
                                <div
                                    ...
                                    <div>
                                        <label style="cursor:pointer;">
                                            <span>
                                                <input class="form-control stretched-link pic1" type="file" accept="image/*"
                                                    id="pic" name="my-image" id="image"
                            ...
                            <div class="col-md-5">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input class="form-control" type="text" name="redirection" required
                            ...
                            <div class="col-md-5 row">
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" type="color" name="bgcolor" required
                                        placeholder="Section background color">

                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Text Color</label>
                                    <input class="form-control" type="color" name="textcolor" required
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <!-- Image -->
                                            <div class="w-100px">
                                                <img src="{{ Storage::url('files/' . $whatsnew_list->image) }}" class="rounded"
                                                    alt="">
                                            </div>
                                    ...
                                    <td>
                                        @can('Whtas New edit')
                                            <a data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Reset"
                                                aria-label="Reset" href="#" data-id="{{ $whatsnew_list->id }}"
                                        ...
                                        @can('Whtas New delete')
                                            <a data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Delete"
                                                aria-label="Delete" data-id="{{ $whatsnew_list->id }}"
                                                href="{{ route('adminkpsc.whats-new.delete', $whatsnew_list->id) }}"
    ...
    <!-- Modal -->
    <div class="modal fade" id="edit_modal" tabindex="-1" role="dialog" aria-labelledby="edit__modal"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="edit__modal">Edit Whatsnew</h5>
                    <button type="button" class="close" onclick="$('#edit_modal').modal('hide');" data-dismiss="modal"
                        aria-label="Close">
